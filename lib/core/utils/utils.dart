...
// ignore_for_file: avoid_dynamic_calls, require_trailing_commas, use_string_buffers, strict_raw_type, avoid_bool_literals_in_conditional_expressions
...
class MyUtils {
  ...
  static String getTempLink({int height = 812, int width = 375}) {
    final rand = Random();
    final value = rand.nextInt(height);
  ...
  static String getInitials(String name) {
    ...
    final nameParts = name.trim().split(pattern);

    // Handle names with only one part
